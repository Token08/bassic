...
export const localizedLabels = {
  ...
  ko: {
    ...
    call: "전화하기",
    reserve: "메일 예약",
    hours: "일반 영업: 20:00 오픈 / L.O. 1:30 / 2:00 마감",
    eventHours: "이벤트 당일은 영업 시간이 변동될 수 있습니다. 이벤트 스케줄을 확인해 주세요.",
    charge: "차지: 1인 500엔",
    smoking: "실내 흡연 가능: 종이담배・전자담배 가능",
    directions: "길찾기",
    menuLink: "메뉴 보기",
    address: "주소",
    phone: "전화",
  ...
  "zh-hant": {
    ...
    call: "撥打電話",
    reserve: "郵件預約",
    hours: "一般營業: 20:00 OPEN / L.O. 1:30 / 2:00 CLOSE",
    eventHours: "活動日營業時間可能變動，請確認活動行程頁面。",
    charge: "座位費: 每人500日圓",
  ...
  "zh-hans": {
    ...
    call: "拨打电话",
    reserve: "邮件预约",
    hours: "通常营业: 20:00 OPEN / L.O. 1:30 / 2:00 CLOSE",
    eventHours: "活动日营业时间可能变动，请查看活动日程页面。",
    charge: "座位费: 每人500日元",
